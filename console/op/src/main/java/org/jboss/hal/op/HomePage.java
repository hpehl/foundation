        ...
        return singletonList(pageMainSection()
                ...
                .add(descriptionList()
                        .addGroup(descriptionListGroup()
                                ...
                                .addDescription(descriptionListDescription(env().applicationId))
                                .addTerm(descriptionListTerm("Name"))
                                .addDescription(descriptionListDescription(env().applicationName))
                                .addTerm(descriptionListTerm("Version"))
                                .addDescription(descriptionListDescription(env().applicationVersion))
