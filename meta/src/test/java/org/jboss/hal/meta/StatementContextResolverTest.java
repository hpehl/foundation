...
class StatementContextResolverTest {
    ...
    void resolveKnownPlaceholders() {
        StatementContextResolver resolver = new StatementContextResolver(statementContext(
                ...
                new String[]{"primary", "hello-world", "secondary", "full", "server1", "server2", "main-server-group"}));
        ...
        assertEquals("server-group=main-server-group", resolver.resolve(AddressTemplate.of("{selected.server-group}")).template);
    }
    ...
    private StatementContext statementContext(Placeholder[] placeholders, String[] values) {
        StatementContext statementContext = new StatementContext();
